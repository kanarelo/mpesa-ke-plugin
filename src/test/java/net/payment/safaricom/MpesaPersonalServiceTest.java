...
public class MpesaPersonalServiceTest extends
		MpesaPaymentServiceTest<MpesaPersonalService> {
	...
	protected void init() {
		...
		outgoingPayment.setPaymentServiceSettings(mpesaPaymentService
				.getSettings());
		...
		mockOutgoingPaymentsDao(PHONENUMBER_0, new BigDecimal("1235"),
				OUTGOING_LIST_0);
		mockOutgoingPaymentsDao(PHONENUMBER_1, new BigDecimal("1235"),
				OUTGOING_LIST_1);
		mockOutgoingPaymentsDao(PHONENUMBER_2, new BigDecimal("1235"),
				new ArrayList<OutgoingPayment>());
	}

	private void mockOutgoingPaymentsDao(String phoneNumber,
			BigDecimal amountPaid, List<OutgoingPayment> Return_List) {
		when(
				outgoingPaymentDao.getByPhoneNumberAndAmountPaid(phoneNumber,
						amountPaid, OutgoingPayment.Status.UNCONFIRMED))
	...
	public void testValidBalanceFraudCheck() throws DuplicateKeyException {
		...
		testOutgoingPaymentProcessing(
				"BC77RI604 Confirmed. "
						...
						+ "New M-PESA balance is Ksh1,000", PHONENUMBER_1,
	...
	public void testInvalidBalanceFraudCheck() throws DuplicateKeyException {
		...
		testOutgoingPaymentProcessing(
				"BC77RI604 Confirmed. "
						+ "Ksh1,235 sent to DACON OMONDI +254723908001 on 22/5/11 at 10:35 PM "
						+ "New M-PESA balance is Ksh5,500", PHONENUMBER_1,
				ACCOUNTNUMBER_1_1, "1235", "BC77RI604", "DACON OMONDI",
				"22/5/11 10:35 PM", OutgoingPayment.Status.UNCONFIRMED);
